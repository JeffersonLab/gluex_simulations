...
#
echo -=-run gen_omega_3pi-=-
#echo -=-run genr8-=-
set seed = $run$file
#set command = "genr8 -Agen.ascii -M$number_of_events -r$run -s$seed < gammapi0.input"
set command = "gen_omega_3pi -c $HALLD_HOME/src/programs/Simulation/gen_omega_3pi/gen_omega_3pi.cfg -hd gen.hddm -o gen.root -s $seed -r $run -n $number_of_events"
...
#
mv -v hdgeant_smeared.hddm hdgeant_smeared_${run}_${file}.omega.hddm
mv -v dana_rest.hddm dana_rest_${run}_${file}.omega.hddm
mv -v hd_root.root hd_root_${run}_${file}.omega.root
mv -v tree_bcal_hadronic_eff.root  tree_bcal_hadronic_eff_${run}_${file}.omega.root  
mv -v tree_fcal_hadronic_eff.root  tree_fcal_hadronic_eff_${run}_${file}.omega.root  
mv -v tree_sc_eff.root  tree_sc_eff_${run}_${file}.omega.root  
mv -v tree_tof_eff.root  tree_tof_eff_${run}_${file}.omega.root
#
