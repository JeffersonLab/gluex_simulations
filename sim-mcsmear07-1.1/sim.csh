...
date
echo -=create dummy output files=-
touch hdgeant_smeared_${run}_${file}.bggen.hddm
touch dana_rest_${run}_${file}.bggen.hddm
touch hd_root_${run}_${file}.bggen.root
touch tree_bcal_hadronic_eff_${run}_${file}.bggen.root  
touch tree_fcal_hadronic_eff_${run}_${file}.bggen.root  
touch tree_sc_eff_${run}_${file}.bggen.root  
touch tree_tof_eff_${run}_${file}.bggen.root
#
...
#
mv -v hdgeant_smeared.hddm hdgeant_smeared_${run}_${file}.bggen.hddm
mv -v dana_rest.hddm dana_rest_${run}_${file}.bggen.hddm
mv -v hd_root.root hd_root_${run}_${file}.bggen.root
mv -v tree_bcal_hadronic_eff.root  tree_bcal_hadronic_eff_${run}_${file}.bggen.root  
mv -v tree_fcal_hadronic_eff.root  tree_fcal_hadronic_eff_${run}_${file}.bggen.root  
mv -v tree_sc_eff.root  tree_sc_eff_${run}_${file}.bggen.root  
mv -v tree_tof_eff.root  tree_tof_eff_${run}_${file}.bggen.root
#
